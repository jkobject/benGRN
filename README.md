...
- 🎯 Entry points to execute your program using `python -m <bengrn>` or `$ bengrn` with basic CLI argument parsing.
...
Awesome bengrn created by jkobject
...
```py
from bengrn import BaseClass
from bengrn import base_function
